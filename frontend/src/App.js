      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          >
            ...
            <svg width="58" height="2" className="flex-shrink-0">
              <line x1="0" y1="1" x2="58" y2="1" stroke="rgba(255,255,255,0.5)" strokeWidth="1" strokeDasharray={dotStyle} strokeLinecap="round" />
            </svg>
