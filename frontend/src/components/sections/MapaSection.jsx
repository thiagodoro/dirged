...
const MapaSection = () => {
  ...
  const locations = [
    { id: 1, lat: -19.9409, lng: -43.9369, color: "#FF007F", units: "Ed. Oxford — DIRGED, ASGID, GEJUR, GEDAN, GEDOC, COJUR, COGEDE", address: "R. Raul Pompeia, 101 - São Pedro" },
    { id: 2, lat: -19.9259192, lng: -43.9354585, color: "#FFE600", units: "Anexo I — COBIB, COMEX", address: "R. Goiás, 229 - Centro" },
    { id: 3, lat: -19.9140383, lng: -43.9365185, color: "#9D00FF", units: "CEOP — COARQ, COMEX", address: "Av. do Contorno, 629 - Centro" },
    { id: 4, lat: -19.9445719, lng: -43.9222717, color: "#00D4FF", units: "Ed. Sede — COBIB, COMEX", address: "Av. Afonso Pena, 4001 - Serra" },
    { id: 5, lat: -19.9117456, lng: -44.0462546, color: "#FF6B35", units: "Cincão — CORCEN, CORAV, COARPE", address: "Av. Ápio Cardoso, 577 - Cincão - Contagem" },
    ...
    { id: 8, lat: -19.9764, lng: -44.0148, color: "#F472B6", units: "Fórum do Barreiro — CORCEN", address: "R. Flávio Marques Lisboa, 464 - Barreiro de Baixo" },
  ];
